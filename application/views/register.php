                            ...
                            <div class="card z-index-0">
                                <div class="card-body">
                                    <form action="<?=base_url('User/addUser')?>" method="post">
                                        <div class="mb-3">
                                            <input type="text" class="form-control" name="firstName" placeholder="firstName" aria-label="Name" aria-describedby="email-addon" required>
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" class="form-control" name="lastName" placeholder="lastName" aria-label="Name" aria-describedby="email-addon" required>
                                        </div>
                                        <div class="mb-3">
